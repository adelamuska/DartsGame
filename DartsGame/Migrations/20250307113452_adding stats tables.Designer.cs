...
namespace DartsGame.Migrations
{
    ...
    [Migration("20250307113452_adding stats tables")]
    partial class addingstatstables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DartsGame.Entities.LegStats", b =>
                {
                    b.HasOne("DartsGame.Entities.Leg", null)
                        .WithMany("LegStats")
                        .HasForeignKey("LegId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("DartsGame.Entities.Leg", "Leg")
                        .WithMany()
                        .HasForeignKey("LegId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DartsGame.Entities.Player", null)
                        .WithMany("LegStats")
                        .HasForeignKey("PlayerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("DartsGame.Entities.MatchStats", b =>
                {
                    b.HasOne("DartsGame.Entities.Match", null)
                        .WithMany("MatchStats")
            ...
            modelBuilder.Entity("DartsGame.Entities.SetStats", b =>
                {
                    ...
                    b.HasOne("DartsGame.Entities.Set", null)
                        .WithMany("SetStats")
                        .HasForeignKey("SetId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
